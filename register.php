...
<body>
    ...
    <section class="mt-48 container mx-auto">
        <section class="">
            <form action="registerAction.php" method="POST" onclick="signUp()">
